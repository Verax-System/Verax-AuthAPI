...
class User(Base):
    ...
    verification_token_hash: Mapped[Optional[str]] = mapped_column(String(255), index=True) 
    ...
    is_mfa_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, server_default='false')
    # --- FIM NOVOS CAMPOS ---
